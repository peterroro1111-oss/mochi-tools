    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      {!file ? (
        ...
        >
          ...
          <p className="text-gray-600 font-medium mb-2">拖放 {fromLabel} 檔案到這裡</p>
          <p className="text-sm text-gray-400">或點擊選擇檔案</p>
          <input
            ref={fileInputRef}
            type="file"
            accept={acceptTypes}
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              {resultSize > 0 && (
                <div className="text-right">
                  <p className="text-sm text-gray-400">轉換後</p>
                  <p className="font-medium text-emerald-500">{formatSize(resultSize)}</p>
                </div>
              )}
            </div>
            {previewUrl && (
              <img src={previewUrl} alt="預覽" className="max-h-64 mx-auto rounded-xl" />
            )}
          </div>
