...
const PRESETS = [
  { label: '輕度壓縮', desc: '畫質幾乎不變', value: 85, icon: '🌟' },
  { label: '推薦', desc: '畫質與大小平衡', value: 65, icon: '👍' },
  { label: '最小檔案', desc: '大幅縮小', value: 40, icon: '🗜️' },
];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">圖片壓縮</h1>
        <p className="text-[#b89b8a]">支援 JPG、PNG、WebP，批次壓縮多張圖片 🔒</p>
      </div>

      {/* Quality presets */}
      <div className="bg-white rounded-2xl border-2 border-pink-100 p-5 mb-6">
        <p className="text-sm font-medium text-gray-700 mb-3">壓縮程度</p>
      ...
      >
        ...
        <p className="text-gray-600 font-medium mb-1">
          {processing ? '壓縮中...' : '拖放圖片到這裡'}
        </p>
        <p className="text-sm text-gray-400">或點擊選擇檔案（可多選）</p>
        <input
          ref={fileInputRef}
          type="file"
        ...
        <>
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl border-2 border-emerald-200 p-5 mb-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">共 {results.length} 張圖片</p>
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-400">節省空間</p>
              </div>
            </div>
          </div>
